...
class _TertiaryButtonState extends State<TertiaryButton> {
  ...
  Widget build(BuildContext context) {
    var enabledStyle = ElevatedButton.styleFrom(
      backgroundColor: widget.color ?? LongaColor.tangerine,
    ...
    var lineArtStyle = ElevatedButton.styleFrom(
      ...
      foregroundColor: widget.textColor ?? LongaColor.tangerine, // textColor
      shadowColor: Colors.transparent,
      elevation: 0,
      ...
      side: BorderSide(
          width: 2, color: widget.textColor ?? LongaColor.tangerine),
    );
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      ...
                      color: (widget.type == ButtonType.line_art)
                          ? widget.textColor ?? LongaColor.tangerine
                          : null,
                    ),
