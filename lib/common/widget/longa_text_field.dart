...
class LongaTextField extends StatefulWidget {
  const LongaTextField({
    Key? key,
    this.hintText,
    this.label,
    this.inputType,
  ...
  @override
  State<LongaTextField> createState() => _SabanzuriTextFieldState();
}

class _SabanzuriTextFieldState extends State<LongaTextField> {
  String? selectedDate;
        ...
        SizedBox(
          child: Focus(
            ...
            child: TextFormField(
              ...
              obscuringCharacter: "*",
              cursorColor: LongaColor.warm_grey_three,
              ...
              decoration: widget.inputDecoration ??
                  InputDecoration(
                    ...
                    fillColor: (LongaColor.white_five),
                    filled: true,
